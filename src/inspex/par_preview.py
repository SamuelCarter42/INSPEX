...
def param_preview(x_data,y_data,parvals,header):
    ...
    def test_func(x,parvals,header): # this function is the one we are trying to fit to the data
        ...
        if header[9]=='1':# ie if the broken power law is present
            ...
            x0_bpl=parvals["x0_bpl"]
            dx_bpl=parvals["dx_bpl"]   
            y+=inspex.broken_power_law(x,x1,A,B,A2,B2,x0_bpl,dx_bpl)
        ...
        if header[28]=='1':#ie if the therm func is present 
            ...
            T=parvals["T"]
            alpha=parvals["alpha"]
            y+=inspex.therm_func(x,amp,T,alpha)
        
        if header[42]=='1': #ie if gaussian is present
            gauss_amp=parvals["gauss_amp"]
            gauss_centre=parvals["gauss_centre"]
            sigma=parvals["sigma"]
            y+=inspex.gauss_func(x, gauss_amp, gauss_centre, sigma)
        ...
        if header[56]=='1': #ie if single power law is present
            ...
            x0_sing=parvals["x0_sing"]
            dx_sing=parvals["dx_sing"]   
            y+=inspex.power_func(x, A_sing, B_sing,x0_sing,dx_sing)
        ...
        if header[70]=='1': #ie if kappa is present
            ...
            n_i=parvals["n_i"]
            kappa=parvals["kappa"]
            y+=inspex.kappa_func(x, A_k, T_k, m_i,n_i,kappa)
        ...
        if header[92]=='1':
            ...
            y+=inspex.bpl_and_therm_func(x,amp_c,T_c,alpha_c,x0_c,x1_c,B_c,B2_c)
        ...
        if header[118]=='1':#ie if the double therm func is present 
            ...
            T_d_2=parvals["T_d_2"]
            alpha_d_2=parvals["alpha_d_2"]
            y+=inspex.double_therm_func(x,amp_d_1,T_d_1,alpha_d_1,amp_d_2,T_d_2,alpha_d_2)
        ...
        if header[130]=='1':# ie if the triple power law is present
            ...
            x0_tpl=parvals["x0_tpl"]
            dx_tpl=parvals["dx_tpl"]   
            y+=inspex.triple_power_law(x,x1_tpl,x2_tpl,A_tpl,B_tpl,A2_tpl,B2_tpl,A3_tpl,B3_tpl,x0_tpl,dx_tpl)
        ...
        if header[142]=='1':# ie if the quad power law is present
            ...
            x0_qpl=parvals["x0_qpl"]
            dx_qpl=parvals["dx_qpl"]   
            y+=inspex.quad_power_law(x,x1_qpl,x2_qpl,x3_qpl,A_qpl,B_qpl,A2_qpl,B2_qpl,A3_qpl,B3_qpl,A4_qpl,B4_qpl,x0_qpl,dx_qpl)
        ...
        if header[159]=='1':# ie if the quint power law is present
            ...
            x0_5pl=parvals["x0_5pl"]
            dx_5pl=parvals["dx_5pl"]   
            y+=inspex.quint_power_law(x, x1_5pl, x2_5pl, x3_5pl, x4_5pl, A_5pl, B_5pl, A2_5pl, B2_5pl, A3_5pl, B3_5pl, A4_5pl, B4_5pl, A5_5pl, B5_5pl,x0_5pl,dx_5pl)
    ...
    if header[28]=='1':#ie if the therm func is present 
        fit2=inspex.therm_func(x_model,amp,T,alpha)
    ...
    if header[9]=='1':# ie if the bpl is present
        ...
        fit3=inspex.lin_func(x_model,A,B)*xlo
        fit4=inspex.lin_func2(x_model,A2,B2)*xhi
    ...
    if header[130]=='1':# ie if the tpl is present
        ...
        fit12=inspex.lin_func(x_model,A_tpl,B_tpl)*xlo
        fit13=inspex.lin_func2(x_model,A2_tpl,B2_tpl)*xmid
        fit14=inspex.lin_func2(x_model,A3_tpl,B3_tpl)*xhi
    ...
    if header[142]=='1':# ie if the qpl is present
        ...
        fit15=inspex.lin_func2(x_model,A_qpl,B_qpl)*xlo
        fit16=inspex.lin_func2(x_model,A2_qpl,B2_qpl)*xmid1
        fit17=inspex.lin_func2(x_model,A3_qpl,B3_qpl)*xmid2
        fit18=inspex.lin_func2(x_model,A4_qpl,B4_qpl)*xhi
    ...
    if header[159]=='1':# ie if the 5pl is present
        ...
        fit19=inspex.lin_func2(x_model,A_5pl,B_5pl)*xlo
        fit20=inspex.lin_func2(x_model,A2_5pl,B2_5pl)*xmid1
        fit21=inspex.lin_func2(x_model,A3_5pl,B3_5pl)*xmid2
        fit22=inspex.lin_func2(x_model,A4_5pl,B4_5pl)*xmid3
        fit23=inspex.lin_func2(x_model,A5_5pl,B5_5pl)*xhi
